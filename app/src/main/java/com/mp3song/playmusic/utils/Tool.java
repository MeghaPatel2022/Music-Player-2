...
public class Tool {
    ...
    private final ArrayList<WallpaperChangedNotifier> notifiers = new ArrayList<>();
    private final ArrayList<Boolean> CallFirstTime = new ArrayList<>();
    private final boolean mDarkWallpaper = false;
    private final int mAverageColor = Color.WHITE;
