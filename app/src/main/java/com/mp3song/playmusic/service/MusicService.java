package com.mp3song.playmusic.service;
...
import com.mp3song.playmusic.models.AbsCustomPlaylist;
...
import com.mp3song.playmusic.musicglide.helper.ShuffleHelper;
import com.mp3song.playmusic.musicglide.helper.StopWatch;
import com.mp3song.playmusic.provider.HistoryStore;
import com.mp3song.playmusic.provider.MusicPlaybackQueueStore;
import com.mp3song.playmusic.provider.SongPlayCountStore;
import com.mp3song.playmusic.service.notification.PlayingNotification;
import com.mp3song.playmusic.service.notification.PlayingNotificationImpl;
import com.mp3song.playmusic.service.notification.PlayingNotificationImpl24;
import com.mp3song.playmusic.service.playback.Playback;
...
/**
 * @author Megha Patel, Andrew Neal
 */
public class MusicService extends Service implements SharedPreferences.OnSharedPreferenceChangeListener, Playback.PlaybackCallbacks {
    ...
    public void toggleShuffle() {
        if (getShuffleMode() == SHUFFLE_MODE_NONE) {
            ...
            Toasty.normal(getApplicationContext(), "Shuffle On", Toasty.LENGTH_SHORT).show();
        } else {
            setShuffleMode(SHUFFLE_MODE_NONE);
            Toasty.normal(getApplicationContext(), "Shuffle Off", Toasty.LENGTH_SHORT).show();
        }
    }
