...
import com.mp3song.playmusic.models.lyrics.AbsSynchronizedLyrics;
...
//                    MusicPlayerRemote.removeFromQueue(song);
            ...
            Toasty.info(context, context.getString(R.string.deleted_x_songs, songs.size()), Toasty.LENGTH_SHORT).show();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
