...
import com.mp3song.playmusic.addon.rest.LastFMRestClient;
import com.mp3song.playmusic.addon.rest.model.LastFmArtist;
import com.mp3song.playmusic.utils.LastFMUtil;
                        ...
                        if (imageListItem != null) {
                            ...
                            switch (mImageNumber) {
                                ...
                                case ArtistImage.FIRST:
                                    ...
                                    break;
                                default:
                                    if (mImageNumber > result.size() - 1)
                                        urlString = result.get(result.size() - 1);
