...
public class CircularPlayPauseProgressBar extends View {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            mColor = t.getColor(R.styleable.CircularPlayPauseProgressBar_iconTint, getResources().getColor(R.color.text_color_back));
            t.recycle();
        }
...
//        mPauseDrawable = getResources().getDrawable(R.drawable.img_next);
       /* if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
