...
import com.mp3song.playmusic.databinding.ItemPlaylistBinding;
...
public class PlaylistChildAdapter extends RecyclerView.Adapter<PlaylistChildAdapter.ItemHolder> {
    ...
    public ItemHolder onCreateViewHolder(@NotNull ViewGroup viewGroup, int i) {
        ItemPlaylistBinding playlistBinding =
                DataBindingUtil.inflate(LayoutInflater.from(viewGroup.getContext()), R.layout.item_playlist, viewGroup, false);
    ...
    public void onBindViewHolder(@NotNull final ItemHolder itemHolder, int i) {
        ...
        itemHolder.playlistBinding.image.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                LocalBroadcastManager lbm = LocalBroadcastManager.getInstance(getContext());
                Intent localIn;
                localIn = new Intent("REFRESH");
                localIn.putExtra("receive", "PlayList");
                localIn.putExtra("object", (Serializable) playlist);
...
//                }
                songList = new ArrayList<>(PlaylistSongLoader.getPlaylistSongList(mContext, id));
            }
            return songList;
        }
        return songList;
    ...
    private static class PlaylistBitmapLoader extends AsyncTask<Void, Void, Bitmap> {
        ...
        protected Bitmap doInBackground(Void... v) {
            ...
            if (adapter != null && itemHolder != null) {
                Log.e("LLL_PlayListName: ", mPlaylist.name + "   " + mPlaylist.id);
    ...
    public class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnTouchListener {
        ...
        private final ItemPlaylistBinding playlistBinding;

        int currentColor = 0;

        ItemHolder(ItemPlaylistBinding playlistBinding) {
            super(playlistBinding.getRoot());
            this.playlistBinding = playlistBinding;
            playlistBinding.image.setOnClickListener(this);
